...
### Changed
- **Agent Skills open standard compliance** (2026-03-06): The `/cold-start-audit` skill now explicitly follows the [Agent Skills](https://agentskills.io) open standard, making it compatible with Claude Code, Cursor, GitHub Copilot, Gemini CLI, OpenAI Codex, and 30+ other Agent Skills-compatible tools. Added `badge-agentskills.svg` and standard compliance note to README.
